...
namespace Coherence.Tend.Tests
{
    ...
    public class OutgoingLogicTest
    {
        ...
        public void ReceivedByRemote_IsSuccessor_CreatesInfo(byte sequence1, byte sequence2, bool delivered)
        {
            ...
            // Act - sequence1
            outgoingLogic.ReceivedByRemote(sequenceId1, mask);
            ...
            // Act - sequence1
            outgoingLogic.ReceivedByRemote(sequenceId2, mask);
        ...
        public void ReceivedByRemote_NotSuccessor_ThrowsException()
        {
            ...
            // Act
            outgoingLogic.ReceivedByRemote(sequenceId1, new ReceiveMask());

            // Assert
            Assert.Throws<UnorderedPacketException>(() => outgoingLogic.ReceivedByRemote(sequenceId2, new ReceiveMask()));
        }
        ...
        public void ReceivedByRemote_SameSequenceId_DoesNothing()
        {
            ...
            // Act
            outgoingLogic.ReceivedByRemote(sequenceId, new ReceiveMask());

            // empty info queue
            while (outgoingLogic.Count > 0)
            {
                outgoingLogic.Dequeue();
            }
        ...
        public void ReceivedByRemote_Random_CreatesInfo()
        {
            ...
            // Act
            outgoingLogic.ReceivedByRemote(new SequenceId(31), new ReceiveMask(mask));
        ...
        {
            Assert.AreEqual(0, outgoingLogic.Count);
            Assert.AreEqual(SequenceId.Max, outgoingLogic.OutgoingSequenceId);
        ...
        public void IncreaseOutgoingSequenceId_Cant_ShouldThrow(byte sequenceId)
        {
            ...
            Assert.Throws<Exception>(() => outgoingLogic.IncreaseOutgoingSequenceId());
        }
        ...
        public void IncreaseOutgoingSequenceId_Can_ShouldIncrement(byte sequenceId)
        {
            ...
            // Act
            outgoingLogic.IncreaseOutgoingSequenceId();
