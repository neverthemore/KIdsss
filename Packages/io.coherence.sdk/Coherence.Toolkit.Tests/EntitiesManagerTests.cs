...
namespace Coherence.Toolkit.Tests
{
    ...
    public class EntitiesManagerTests : CoherenceTest
    {
        ...
        // in the actual CCM.
        private HashSet<CoherenceClientConnection> connections = new();

        delegate bool DoRemove(Entity id, out CoherenceClientConnection connection);
        ...
        public override void SetUp()
        {
            ...
            (mockBridge, mockClient) = new MockBridgeBuilder()
                .SetClientID(client0)
                .Build();
            ...
            mockConnectionManager.Setup(manager => manager.Add(It.IsAny<CoherenceClientConnection>()))
                ...
                {
                    bool wasAdded = connections.Add(connection);
            ...
            mockConnectionManager.Setup(manager => manager.Remove(It.IsAny<Entity>()))
                .Returns((Entity id) =>
                {
                    var connection = connections.FirstOrDefault(conn => conn.EntityId == id);
        ...
        public void WhenClientDisconnects_AllEntitiesAreClearedIfCoherenceSyncHandleDisconnectedThrows()
        {
            ...
            Assert.That(logger.GetLogLevelCount(LogLevel.Error), Is.EqualTo(1));
            logger.ClearLogLevelCount(LogLevel.Error);
        ...
        [Test]
        [Description("Verifies that the returned entity state for unsynced entities is not null.")]
        [Ignore("Disabled until we can work on fixing this issue: https://app.zenhub.com/workspaces/engine-group-5fb3b64dabadec002057e6f2/issues/gh/coherence/unity/5289")]
        public void Test_GetNetworkEntityStateForUnsyncedEntityReturnsState()
        {
            // Arrange
            var mockComp = new MockComponentData(42);
            var comps = new ICoherenceComponentData[] { mockComp };
        ...
        public void Test_HierarchyCreatedInAnyOrder(string[] createOrder)
        {
            ...
            // if B was created, we can sync it.
        ...
        private MockSyncBuilder.Result CreateNetworkedEntityWithResult(Entity entityID, ICoherenceComponentData[] comps, Entity parent, ClientID? clientID = null)
        {
