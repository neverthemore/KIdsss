...
namespace Coherence.Runtime.Tests.Lobbies
{
    ...
    public class LobbyOwnerSessionTests : CoherenceTest
    {
        ...
        private string GetPlayerPath(Player player) => $"/{lobbyData.Id}/players/{player.UserId}";
        ...
        [Test(Description = "KickPlayer should send a DELETE request to the lobbies endpoint with the player's UserId.")]
        [TestCase(true)]
        [TestCase(false)]
        public void KillPlayer(bool success)
        {
            ...
            var player = new Player { UserId = "player123" };
        ...
        [Test(Description = "KickPlayerAsync should send a DELETE request to the lobbies endpoint with the player's UserId.")]
        [TestCase(true)]
        [TestCase(false)]
