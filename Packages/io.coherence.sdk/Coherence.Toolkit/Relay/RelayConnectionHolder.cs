namespace Coherence.Toolkit.Relay
{
    ...
    internal class RelayConnectionHolder
    {
        ...
        internal RelayConnectionHolder(EndpointData endpointData, IRelayConnection relayConnection, Logger logger)
        {
            replicationServerTransport = new UdpTransport(new StubStats(), logger);
