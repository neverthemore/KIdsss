...
namespace Coherence.Tend.Client
{
    ...
    public class Tend
    {
        ...
        public TendHeader WriteHeader(IOutOctetStream stream, bool isReliable)
        {
            ...
            var tendBeforeIncrement = tendOut.OutgoingSequenceId;
            ...
            {
                // Revert outgoing packetId in case an exception is thrown
                tendOut.OutgoingSequenceId = tendBeforeIncrement;
                throw;
            }
        }
