...
namespace Coherence.Runtime
{
    internal static class PrefsKeys
    {
        ...
        /// <summary>
        /// Prefs key used to store the username of the last user that was logged in, in coherence 1.3.0 and older.
        /// </summary>
        public const string CachedLegacyUsername = "Coherence.Proj{0}.Id{1}.AuthUserName";

        /// <summary>
        /// Prefs key used to store the password of the last user that was logged in as a guest, in coherence 1.3.0 and older.
        /// </summary>
        public const string CachedLegacyGuestPassword = "Coherence.Proj{0}.Id{1}.AuthGuestPassword";

        /// <summary>
        /// Prefs key used to store the session token of the last user that was logged in, in coherence 1.3.0 and older.
        /// </summary>
