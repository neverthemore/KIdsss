...
namespace Coherence.Cloud
{
    ...
    public class RequestFactory : IUpdatable, IRequestFactory, IDisposableInternal
    {
        ...
        {
            return SendRequestAsync(basePath, string.Empty, method, body, headers, requestName, sessionToken);
        }
