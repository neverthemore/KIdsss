...
namespace Coherence.Cloud
{
    ...
    internal static class AttributesExtensions
    {
        ...
        public static void MergeAttributesWith(this Player player, List<CloudAttribute> newAttributes)
        {
            MergeAttributesWith(ref player.playerAttributes, newAttributes);
        }
