...
namespace Coherence.Cloud
{
    ...
    public class ReplicationServerRoomsService : IRoomsService, IDisposable
    {
        ...
        {
            var exists = await ReplicationServerUtils.PingHttpServerAsync(localRoomsIp, localRoomsApiPort);
        ...
        public async Task<IReadOnlyList<RoomData>> FetchRoomsAsync(string[] tags = null)
        {
            ...
            var response = await requestFactory.SendCustomRequestAsync(endpoint, localRoomsGetMethod,
                                                                          "GET", null);
            try
            {
