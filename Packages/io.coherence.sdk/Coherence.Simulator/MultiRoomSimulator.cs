...
namespace Coherence.Simulator
{
    ...
    [AddComponentMenu("coherence/Multi-Room Simulators/Multi-Room Simulator")]
    [NonBindable]
    public sealed class MultiRoomSimulator : CoherenceBehaviour
    {
        public static MultiRoomSimulator Instance { get; private set; }

        private readonly Dictionary<EndpointData, CoherenceSceneLoader> loaders = new Dictionary<EndpointData, CoherenceSceneLoader>();
