...
#pragma warning restore 649
        ...
        private static Schema[] ActiveSchemas()
        {
            ...
            if (ProjectSettings.instance.UseToolkit && File.Exists(Paths.toolkitSchemaPath))
            {
                schemas.Add(Schema.GetFromString(File.ReadAllText(Paths.toolkitSchemaPath)));
            }

            if (ProjectSettings.instance.UseCoherenceSyncSchema && File.Exists(Paths.gatherSchemaPath))
            {
            ...
            {
                var activeSchemas = ProjectSettings.instance.activeSchemas.Select(s => Schema.GetFromSchemaAsset(s));
            ...
            if (ProjectSettings.instance.RuntimeSettings.extraSchemas != null)
            {
                ...
                .Where(s => s != null)
                .Select(s => Schema.GetFromSchemaAsset(s));
