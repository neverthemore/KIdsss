...
namespace Coherence.Toolkit
{
    ...
    internal static class EditorCache
    {
        ...
        public static bool UpdateBindings(CoherenceSync sync, bool forceUpdate = false)
        {
            ...
            var isVariantAsset = new GameObjectStatus(sync.gameObject).IsVariantAsset;
            var limitVariantPostProcessing = isVariantAsset && !OverrideActions.HasBindingOverrides(sync);
