namespace Coherence.Editor
{
    ...
    internal sealed class BugReportHelper
    {
        ...
        private static IReadOnlyList<Entry> GetEntries(bool includeEditorLog)
        {
            ...
            Add(Paths.PreviousCoherenceLogFilePath, Paths.PreviousCoherenceLogFilePath, true);
            Add(Paths.CurrentCoherenceLogFilePath, Paths.CurrentCoherenceLogFilePath, true);
