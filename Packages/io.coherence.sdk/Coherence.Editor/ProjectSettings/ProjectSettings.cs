...
namespace Coherence.Editor
{
    ...
    {
        public enum CoherenceSyncConfigRegistryMode
        {
            SubAssets,
            StandaloneAssets,
            DynamicStandaloneAssets
        }
        ...
        public string PortalToken => System.Environment.GetEnvironmentVariable("COHERENCE_PORTAL_TOKEN") ?? string.Empty;
        ...
        public bool showHubSectionInfo = true;
        public bool showHubModuleDescription = true;
        public bool showHubMessageAreas = true;
        ...
        [Tooltip("Include reflection schema, required for CoherenceSync to work without performant network scripts.")]
        [SerializeField] private bool useToolkit = true;

        [Tooltip("Include CoherenceSync schema, required for CoherenceSync to work with performant network scripts.")]
        [SerializeField] private bool useCoherenceSyncSchema = true;

        [Tooltip("Allows usage of custom schemas.")]
        [SerializeField] private bool useCustomSchemas;

        [SerializeField]
        public bool RSBundlingEnabled;

        public bool UseToolkit => useToolkit;

        public bool UseCustomSchemas => useCustomSchemas;

        public bool UseCoherenceSyncSchema => useCoherenceSyncSchema;
        ...
        public bool keepConnectionAlive = false;
        ...
        public SchemaAsset[] activeSchemas = new SchemaAsset[] { };
        ...
        public bool TryGetActiveSchemasHash(out Hash128 hash)
        {
            ...
            try
            {
                ...
                if (UseCustomSchemas)
                {
                    raws.AddRange(activeSchemas.Select(s => s.raw));
                }
