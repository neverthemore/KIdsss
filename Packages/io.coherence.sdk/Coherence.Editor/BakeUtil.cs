...
namespace Coherence.Editor
{
    ...
    public static class BakeUtil
    {
        ...
        static BakeUtil()
        {
            HasReflectedModeSupport = TypeCache.GetTypesDerivedFrom<ICoherenceComponentData>()
                .Any(t => t.Name == "GenericFieldInt0");
        ...
        public static bool GatherOnBake
        {
            get => UserSettings.GetBool(gatherOnBakeKey, true);
            set => UserSettings.SetBool(gatherOnBakeKey, value);
        }

        /// <summary>
        ///     Determines if there is reflected mode support.
        /// </summary>
        public static bool HasReflectedModeSupport { get; private set; }
        ...
        /// </summary>
        public static bool CoherenceSyncSchemaOutdated => ProjectSettings.instance.UseCoherenceSyncSchema &&
                                                          (!GatheredSchemaExists || CoherenceSyncSchemasDirty);
        ...
        internal static bool GenerateSchema(out SchemaDefinition schemaDef, out EntitiesBakeData entitiesData)
        {
            ...
            else if (ProjectSettings.instance.RuntimeSettings.extraSchemas != null)
            {
                var schemaList = ProjectSettings.instance.RuntimeSettings.extraSchemas;
                var combined = String.Join("\n", schemaList.Select(s => s.raw));
                schemaDef = SchemaReader.Read(combined);
            ...
            logger.Warning(Warning.EditorBakeUtilGenerateSchemaNoSchema);
            return false;
        }
