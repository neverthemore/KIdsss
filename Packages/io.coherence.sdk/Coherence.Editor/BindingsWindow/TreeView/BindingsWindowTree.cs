...
namespace Coherence.Editor
{
    ...
    internal class BindingsWindowTree : TreeView
    {
        ...
        private CoherenceSync GetSelectedSync()
        {
            return BindingsWindow.Component;
        }
        ...
        private void HandleInput(BindingsTreeViewInput input, BindingsTreeViewBindingItem fromBinding)
        {
            ...
            {
                foreach (BindingsTreeViewBindingItem selectedBinding in selectedBindings)
                {
                    selectedBinding.ApplyInputToBinding(input);
                }
            }
            else
            {
                fromBinding.ApplyInputToBinding(input);
            }
            BindingsWindow.UpdateSerialization();
