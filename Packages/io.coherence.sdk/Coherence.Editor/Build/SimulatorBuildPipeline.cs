    ...
    public static class SimulatorBuildPipeline
    {
        ...
        public static void PrepareHeadlessBuild()
        {
            ...
            var supportsHeadlessLinuxBuild =
                SimulatorEditorUtility.IsBuildTargetSupported(true, SimulatorBuildOptions.Get().ScriptingImplementation);
        ...
        public static void BuildHeadlessLinuxClientAsync()
        {
            ...
            bool changedScriptingSymbols = ScriptingSymbolsChanger.ChangeScriptingSymbols(supportsHeadlessLinuxBuild ? NamedBuildTarget.Server : NamedBuildTarget.Standalone, true);
            bool changedBuildSubTarget = ChangeBuildSubTarget(supportsHeadlessLinuxBuild, false);
            bool changedBuildTarget = ChangeBuildTargetToLinux();

            if (changedScriptingSymbols || changedBuildSubTarget || changedBuildTarget)
            {
