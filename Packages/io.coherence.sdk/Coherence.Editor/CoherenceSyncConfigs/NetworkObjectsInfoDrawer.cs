...
namespace Coherence.Editor
{
    ...
    internal static class NetworkObjectsInfoDrawer
    {
        ...
        private static GUIContent helpText =
            new GUIContent(
                "CoherenceSync Objects are Prefabs with the CoherenceSync component that coherence will automatically sync over the network.");
