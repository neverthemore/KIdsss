...
namespace Coherence.Editor
{
    ...
    internal class CoherenceSyncConfigRegistryEditor : PreloadedSingletonEditor
    {
        ...
        private List<CoherenceSyncConfig> leakedConfigs = new();
        ...
        {
            public static readonly GUIContent openInWindow = EditorGUIUtility.TrTextContentWithIcon(
                "Open CoherenceSync Objects Window",
                "Prefab Icon"
            );
            public static readonly GUIContent helpTitle = new("What is synchronized over the network?");
            public static readonly GUIContent helpContent = new("Prefabs that have a CoherenceSync component attached are ready to be networked. Sometimes they're referred to as 'CoherenceSync Prefabs', 'CoherenceSyncs', 'CoherenceSync Objects' or simply 'Network Entities'.");
        ...
        protected override bool UseMargins()
        {
            return false;
        }
        ...
        protected override void OnGUI()
        {
            ...
            foldout = ContentUtils.DrawFoldout(foldout, GUIContents.helpTitle, GUIContents.helpContent);
            EditorGUILayout.Space();
            DrawConfigs();
        }
        ...
        private void DrawConfigs()
        {
            ...
            EditorGUILayout.LabelField(footer, ContentUtils.GUIStyles.centeredLabel);
        }
