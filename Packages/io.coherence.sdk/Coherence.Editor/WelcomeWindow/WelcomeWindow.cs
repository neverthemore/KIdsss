namespace Coherence.Editor
{
    ...
    internal class WelcomeWindow : EditorWindow
    {
        ...
        public void CreateGUI()
        {
            ...
            root.Q<Label>("VersionLabel").text = CoherenceHub.info.ToString();
            ...
            if (update.IsActive)
            {
                ...
                rootVisualElement.Q<VisualElement>("UpdateMessage").AddToClassList("show-expand-height");
        ...
        private void OpenQuickstart()
        {
            ...
            Application.OpenURL(DocumentationLinks.GetDocsUrl(DocumentationKeys.GettingStarted));
        }

        private void ImportSampleScenes()
        {
            ReportButtonClickedAnalytic("samples");
            UIUtils.ImportPrefabFromPackageSample(_sampleScenesAsset, null);
        }
