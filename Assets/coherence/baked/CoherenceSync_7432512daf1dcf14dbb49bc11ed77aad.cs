...
namespace Coherence.Generated
{
    ...
    public class Binding_7432512daf1dcf14dbb49bc11ed77aad_b80f6bc6720747949a3add30785afca3 : PositionBinding
    {   
    ...
    [UnityEngine.Scripting.Preserve]
    public class CoherenceSync_7432512daf1dcf14dbb49bc11ed77aad : CoherenceSyncBaked
    {
        private Entity entityId;
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSync_7432512daf1dcf14dbb49bc11ed77aad>();
        ...
        {
            ["b80f6bc6720747949a3add30785afca3"] = new Binding_7432512daf1dcf14dbb49bc11ed77aad_b80f6bc6720747949a3add30785afca3(),
        };
        
        private Dictionary<string, Action<CommandBinding, CommandsHandler>> bakedCommandBindings = new Dictionary<string, Action<CommandBinding, CommandsHandler>>();
        
        public CoherenceSync_7432512daf1dcf14dbb49bc11ed77aad()
        {
        }
            ...
            switch (command)
            {
                default:
                    logger.Warning(Coherence.Log.Warning.ToolkitBakedSyncReceiveCommandUnhandled,
                        $"CoherenceSync_7432512daf1dcf14dbb49bc11ed77aad Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_7432512daf1dcf14dbb49bc11ed77aad>();
            this.bridge = bridge;
